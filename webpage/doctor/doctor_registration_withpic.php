...
if(isset($_POST["submit"])){
	...
	// Inserting into database
		...
		if (mysqli_query($link, $sql)) {   					
			...
			if ($mail->send()) {
				$sucess_message = "Thanks for registering!"."<br><br>"."Email has been sent! Please activate your account by clicking on the link that has been sent to you.";
            } else {
...
<section class="container grey-text"> 
	...
	<form action = "doctor_registration.php" method = "POST" enctype="multipart/form-data">
		...
		<input type="file" name="picture" id="picture" accept=".png,.jpg,.jpeg," /></div>
