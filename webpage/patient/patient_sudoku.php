...
?>
  <form action="check_sudoku.php" method="POST">
    ...
    <input type="number" name="13" required class="sudoku" value = <?php if($sudoku[0][2] != 0){echo $sudoku[0][2]; echo " readonly";} ?>>
    ...
    <input type="number" name="16" required class="sudoku" value = <?php if($sudoku[0][5] != 0){echo $sudoku[0][5]; echo " readonly";} ?>> 
    ...
    <input type="number" name="23" required class="sudoku" value = <?php if($sudoku[1][2] != 0){echo $sudoku[1][2]; echo " readonly";} ?>>
    ...
    <input type="number" name="26" required class="sudoku" value = <?php if($sudoku[1][5] != 0){echo $sudoku[1][5]; echo " readonly";} ?>> 
    ...
    <input type="number" name="33" required class="sudoku" value = <?php if($sudoku[2][2] != 0){echo $sudoku[2][2]; echo " readonly";} ?>> 
    ...
    <input type="number" name="36" required class="sudoku" value = <?php if($sudoku[2][5] != 0){echo $sudoku[2][5]; echo " readonly";} ?>>
    ...
    <input type="number" name="39" required class="sudoku" value = <?php if($sudoku[2][8] != 0){echo $sudoku[2][8]; echo " readonly";} ?>><br>
    ...
    <input type="number" name="43" required class="sudoku" value = <?php if($sudoku[3][2] != 0){echo $sudoku[3][2]; echo " readonly";} ?>>
    ...
    <input type="number" name="46" required class="sudoku" value = <?php if($sudoku[3][5] != 0){echo $sudoku[3][5]; echo " readonly";} ?>>
    ...
    <input type="number" name="53" required class="sudoku" value = <?php if($sudoku[4][2] != 0){echo $sudoku[4][2]; echo " readonly";} ?>>
    ...
    <input type="number" name="56" required class="sudoku" value = <?php if($sudoku[4][5] != 0){echo $sudoku[4][5]; echo " readonly";} ?>> 
    ...
    <input type="number" name="63" required class="sudoku" value = <?php if($sudoku[5][2] != 0){echo $sudoku[5][2]; echo " readonly";} ?>>
    ...
    <input type="number" name="66" required class="sudoku" value = <?php if($sudoku[5][5] != 0){echo $sudoku[5][5]; echo " readonly";} ?>>
    ...
    <input type="number" name="69" required class="sudoku" value = <?php if($sudoku[5][8] != 0){echo $sudoku[5][8]; echo " readonly";} ?>><br>
    ...
    <input type="number" name="73" required class="sudoku" value = <?php if($sudoku[6][2] != 0){echo $sudoku[6][2]; echo " readonly";} ?>><nbsp><nbsp><nbsp><nbsp><nbsp><nbsp>
    ...
    <input type="number" name="76" required class="sudoku" value = <?php if($sudoku[6][5] != 0){echo $sudoku[6][5]; echo " readonly";} ?>>
    ...
    <input type="number" name="83" required class="sudoku" value = <?php if($sudoku[7][2] != 0){echo $sudoku[7][2]; echo " readonly";} ?>>
    ...
    <input type="number" name="86" required class="sudoku" value = <?php if($sudoku[7][5] != 0){echo $sudoku[7][5]; echo " readonly";} ?>> 
    ...
    <input type="number" name="93" required class="sudoku" value = <?php if($sudoku[8][2] != 0){echo $sudoku[8][2]; echo " readonly";} ?>>
    ...
    <input type="number" name="96" required class="sudoku" value = <?php if($sudoku[8][5] != 0){echo $sudoku[8][5]; echo " readonly";} ?>>
    ...
    <input class="sudoku" type="number" name="99" required value = <?php if($sudoku[8][8] != 0){echo $sudoku[8][8]; echo " readonly";} ?>> <br>
